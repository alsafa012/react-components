function App() {
     return (
          <>
               <div className="w-[500px] mx-auto border">
                    <div className="relative group ">
                         <img
                              className="w-[80px] h-[80px] bg-slate-500 object-cover rounded-full"
                              src="https://source.unsplash.com/300x300/?profile"
                              alt=""
                         />
                         <span className="h-4 w-4 bg-green-500 absolute rounded-full bottom-2 right-5 border-[3px] border-white"></span>
                         <span className="h-4 w-4 bg-green-500 absolute rounded-full bottom-2 right-5 animate-spin"></span>
                    </div>
                    <div>
